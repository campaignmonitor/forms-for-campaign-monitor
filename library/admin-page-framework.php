...
abstract class CampaignMonitor_AdminPageFramework_Registry_Base {
...
final class CampaignMonitor_AdminPageFramework_Registry extends CampaignMonitor_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['CampaignMonitor_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['CampaignMonitor_AdminPageFramework_RegisterClasses'] : '';
        self::$bIsMinifiedVersion = class_exists('CampaignMonitor_AdminPageFramework_MinifiedVersionHeader');
    }
...
final class CampaignMonitor_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        if (!$this->_isLoadable()) {
            return;
        }
        CampaignMonitor_AdminPageFramework_Registry::setUp($sLibraryPath);
        if (CampaignMonitor_AdminPageFramework_Registry::$bIsMinifiedVersion) {
            return;
        }
        include (CampaignMonitor_AdminPageFramework_Registry::$sAutoLoaderPath);
        new CampaignMonitor_AdminPageFramework_RegisterClasses(empty(CampaignMonitor_AdminPageFramework_Registry::$aClassFiles) ? CampaignMonitor_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('CampaignMonitor_AdminPageFramework_MinifiedVersionHeader', 'CampaignMonitor_AdminPageFramework_BeautifiedVersionHeader',),), CampaignMonitor_AdminPageFramework_Registry::$aClassFiles);
        CampaignMonitor_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('CampaignMonitor_AdminPageFramework_InclusionClassFilesHeader');
    }
...
new CampaignMonitor_AdminPageFramework_Bootstrap(__FILE__);