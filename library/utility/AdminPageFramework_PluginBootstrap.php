 ...
 */
abstract class CampaignMonitor_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('CampaignMonitor_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new CampaignMonitor_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
