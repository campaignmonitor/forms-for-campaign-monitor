 ...
 */
abstract class CampaignMonitor_AdminPageFramework_Widget extends CampaignMonitor_AdminPageFramework_Widget_Controller {
    ...
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new CampaignMonitor_AdminPageFramework_Property_Widget($this, null, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
