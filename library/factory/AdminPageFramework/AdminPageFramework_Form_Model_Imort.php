 ...
 */
abstract class CampaignMonitor_AdminPageFramework_Form_Model_Import extends CampaignMonitor_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new CampaignMonitor_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
