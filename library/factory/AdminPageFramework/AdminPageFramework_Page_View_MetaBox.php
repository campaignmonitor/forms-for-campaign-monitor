 ...
 */
abstract class CampaignMonitor_AdminPageFramework_Page_View_MetaBox extends CampaignMonitor_AdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aCampaignMonitor_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aCampaignMonitor_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aCampaignMonitor_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aCampaignMonitor_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aCampaignMonitor_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aCampaignMonitor_AdminPageFramework']['bAddedMetaBoxScript'] = true;
