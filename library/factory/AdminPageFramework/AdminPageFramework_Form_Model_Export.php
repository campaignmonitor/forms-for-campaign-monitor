 ...
 */
abstract class CampaignMonitor_AdminPageFramework_Form_Model_Export extends CampaignMonitor_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new CampaignMonitor_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
