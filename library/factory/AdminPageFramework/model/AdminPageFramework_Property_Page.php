 ...
 */
class CampaignMonitor_AdminPageFramework_Property_Page extends CampaignMonitor_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aCampaignMonitor_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aCampaignMonitor_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aCampaignMonitor_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aCampaignMonitor_AdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['aCampaignMonitor_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
