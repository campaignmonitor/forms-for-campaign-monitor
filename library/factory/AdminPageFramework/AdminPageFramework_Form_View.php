 ...
 */
abstract class CampaignMonitor_AdminPageFramework_Form_View extends CampaignMonitor_AdminPageFramework_Form_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        ...
        $_oField = new CampaignMonitor_AdminPageFramework_FormField($aField, $_aTemp, $this->aFieldErrors, $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
