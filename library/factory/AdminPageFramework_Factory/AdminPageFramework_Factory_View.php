 ...
 */
abstract class CampaignMonitor_AdminPageFramework_Factory_View extends CampaignMonitor_AdminPageFramework_Factory_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        $_oField = new CampaignMonitor_AdminPageFramework_FormField($aField, $this->oProp->aOptions, $this->_getFieldErrors(), $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
