 ...
 */
class CampaignMonitor_AdminPageFramework_WPUtility_URL extends CampaignMonitor_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(CampaignMonitor_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(CampaignMonitor_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = CampaignMonitor_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
