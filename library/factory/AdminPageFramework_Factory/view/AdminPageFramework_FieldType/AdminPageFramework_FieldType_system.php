 ...
 */
class CampaignMonitor_AdminPageFramework_FieldType_system extends CampaignMonitor_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getPHPInfo($bGenerateInfo = true) {
        ...
        $_oErrorReporting = new CampaignMonitor_AdminPageFramework_ErrorReporting;
