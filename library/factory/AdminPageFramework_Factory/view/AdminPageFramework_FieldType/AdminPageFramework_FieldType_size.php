 ...
 */
class CampaignMonitor_AdminPageFramework_FieldType_size extends CampaignMonitor_AdminPageFramework_FieldType_select {
...
CSSRULES;
    ...
    private function _getUnitSelectInput(array $aField, array $aBaseAttributes, $isKey, $bMultiLabels) {
        ...
        $_oUnitInput = new CampaignMonitor_AdminPageFramework_Input_select($_aUnitAttributes + array('select' => $_aUnitAttributes));
