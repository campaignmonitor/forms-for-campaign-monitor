 ...
 */
class CampaignMonitor_AdminPageFramework_FieldType_select extends CampaignMonitor_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new CampaignMonitor_AdminPageFramework_Input_select($aField['attributes']);
