 ...
 */
abstract class CampaignMonitor_AdminPageFramework_FieldType_Base extends CampaignMonitor_AdminPageFramework_WPUtility {
    ...
    protected function geFieldOutput(array $aField) {
        ...
        $_oField = new CampaignMonitor_AdminPageFramework_FormField($aField, $_aOptions, $_oCaller->getFieldErrors(), $_oCaller->oProp->aFieldTypeDefinitions, $_oCaller->oMsg, $_oCaller->oProp->aFieldCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new CampaignMonitor_AdminPageFramework_Script_MediaUploader($this->oMsg);
        } else {
