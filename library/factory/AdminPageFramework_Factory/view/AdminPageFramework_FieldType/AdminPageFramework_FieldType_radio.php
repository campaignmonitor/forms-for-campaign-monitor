 ...
 */
class CampaignMonitor_AdminPageFramework_FieldType_radio extends CampaignMonitor_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new CampaignMonitor_AdminPageFramework_Input_radio($aField['attributes']);
