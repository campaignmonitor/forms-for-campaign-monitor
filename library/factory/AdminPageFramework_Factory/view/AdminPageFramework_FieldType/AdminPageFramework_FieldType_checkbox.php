 ...
 */
class CampaignMonitor_AdminPageFramework_FieldType_checkbox extends CampaignMonitor_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new CampaignMonitor_AdminPageFramework_Input_checkbox($aField['attributes']);
