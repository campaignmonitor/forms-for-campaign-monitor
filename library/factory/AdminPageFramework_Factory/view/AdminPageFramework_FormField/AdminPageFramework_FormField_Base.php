 ...
 */
abstract class CampaignMonitor_AdminPageFramework_FormField_Base extends CampaignMonitor_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new CampaignMonitor_AdminPageFramework_Script_Widget;
        ...
        new CampaignMonitor_AdminPageFramework_Script_Utility;
        new CampaignMonitor_AdminPageFramework_Script_OptionStorage;
        new CampaignMonitor_AdminPageFramework_Script_AttributeUpdator;
        new CampaignMonitor_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new CampaignMonitor_AdminPageFramework_Script_Sortable;
        new CampaignMonitor_AdminPageFramework_Script_RegisterCallback;
    }
