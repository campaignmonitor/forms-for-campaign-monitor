 ...
 */
class CampaignMonitor_AdminPageFramework_FormTable_Base extends CampaignMonitor_AdminPageFramework_FormOutput {
    public function __construct($aFieldTypeDefinitions, array $aFieldErrors, $oMsg = null) {
        ...
        $this->oMsg = $oMsg ? $oMsg : CampaignMonitor_AdminPageFramework_Message::getInstance();
        $this->_loadScripts();
    }
    ...
    private function _loadScripts() {
        ...
        new CampaignMonitor_AdminPageFramework_Script_Tab;
    }
...
JAVASCRIPTS;
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new CampaignMonitor_AdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new CampaignMonitor_AdminPageFramework_Script_RepeatableSection($this->oMsg);
...
JAVASCRIPTS;
    ...
    protected function _getDebugInfo($sFieldsType) {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . CampaignMonitor_AdminPageFramework_Registry::NAME . ' ' . CampaignMonitor_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}