 ...
 */
abstract class CampaignMonitor_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aCampaignMonitor_AdminPageFramework'] = isset($GLOBALS['aCampaignMonitor_AdminPageFramework']) && is_array($GLOBALS['aCampaignMonitor_AdminPageFramework']) ? $GLOBALS['aCampaignMonitor_AdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => CampaignMonitor_AdminPageFramework_Registry::NAME, 'sURI' => CampaignMonitor_AdminPageFramework_Registry::URI, 'sScriptName' => CampaignMonitor_AdminPageFramework_Registry::NAME, 'sLibraryName' => CampaignMonitor_AdminPageFramework_Registry::NAME, 'sLibraryURI' => CampaignMonitor_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => CampaignMonitor_AdminPageFramework_Registry::getVersion(), 'sDescription' => CampaignMonitor_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => CampaignMonitor_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => CampaignMonitor_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => CampaignMonitor_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => CampaignMonitor_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : CampaignMonitor_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
